...
| [capability_ladder.svg](capability_ladder.svg) | where size stops buying accuracy: four models, one 12 GB card, five standard benchmarks - the 2.83 GB 4B ties the 11.33 GB 30B on MATH-500 (77.6 vs 77.2) and beats the 4.68 GB 7B on every bench measured; rows still running are drawn as gaps, not omitted | `weights/make_capability_ladder.py` | `weights/data/ev1/**/results_*.json` via `weights/ev1_report.py`, prereg 2026-08-06-ev1-standard-benches |
