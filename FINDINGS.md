...
`untested` · `measured` · evidence: per-tier header scan, 2026-07-30; the ladder's format-class residual pattern · wired into: `prereg candidate #79 (with C-13 fixed first - they touch the same statistic)`
