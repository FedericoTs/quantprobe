...
MODELS = {
    "qwen3-30b": {
        ...
        "nl": 48,
        "hint": "Qwen3-30B-A3B",
    },  # 48L x 4KV x 128d (exact; calibration anchor)
    "deepseek-16b": {
        "t": 15.7,
        "a": 2.4,
        "ne": 1.3,
        ...
        "kvp": 31104,
        "nl": 27,
        "hint": "DeepSeek-V2-Lite",
    },  # MLA: 27L x (512+64) latent (exact)
    "gemma-12b": {
        "t": 11.9,
        "a": 11.9,
        "ne": 11.9,
        ...
        "kvp": 65536,
        "hint": "Gemma 4 12B",
    },  # [est] SWA: long-ctx slope from global layers only
    "mistral-7b": {
        "t": 7.2,
        "a": 7.2,
        "ne": 7.2,
    ...
    "glm-air": {
        ...
        "kvp": 188416,
        "nl": 46,
        "hint": "GLM-4.5-Air 106B",
    },  # 46L x 8KV x 128d GQA (exact, zai-org/GLM-4.5-Air config.json)
    "glm-744b": {
        "t": 753.3,
        "a": 32,
        "ne": 8,
        ...
        "nl": 78,
        "hint": "GLM-5.2 (753B)",
    },  # MLA: 78L x (512+64) latent (exact, zai-org/GLM-5.2 config.json); a/ne [est]
    "qwen3-235b": {
        "t": 235.1,
        "a": 22,
        "ne": 7.5,
    ...
    },  # total exact; kvp: 94L x 4KV x 128d [est]
    "kimi-k2.6": {
        "t": 1058.6,
        "a": 32,
        "ne": 6,
        "moe": True,
        "kvp": 70272,
        "hint": "Kimi K2.6 (1T MLA)",
    },  # total exact; kvp: 61L x 576 MLA latent [est]
    "gpt-oss-120b": {
        "t": 120.4,
        "a": 5.1,
        "ne": 1.8,
        ...
        "kvp": 73728,
        "hint": "gpt-oss-120b",
    },  # total+active official; kvp: 36L x 8KV x 64d [est]
    "llama-70b": {
        "t": 70.6,
        "a": 70.6,
        "ne": 70.6,
...
MACHINES = {
    ...
    "2016-xmp": {
        ...
        "geta": 0.35,
        "gl": 0.04,
        "hint": "2016 desktop (GTX 1060 6GB), XMP on [measured]",
    },
    "2016": {
        "vc": 6,
        "vb": 192,
        ...
        "geta": 0.35,
        "gl": 0.04,
        "hint": "2016 desktop, XMP off [measured]",
    },
    ...
    "rtx-3060": {
        ...
        "geta": 0.5,
        "gl": 0.3,
        "hint": "RTX 3060 12GB + DDR4-3200 [est]",
    },
    "rtx-3090": {
        "vc": 24,
        "vb": 936,
    ...
    "laptop-8gb": {
        ...
        "geta": 0.45,
        "gl": 0.28,
        "hint": "gaming laptop, 8GB GPU + DDR5 [est]",
    },
    "gaming": {
        "vc": 12,
        "vb": 360,
        ...
        "geta": 0.5,
        "gl": 0.3,
        "hint": "RTX 3060 12GB + DDR4-3200 [est] (alias of rtx-3060)",
    },
    ...
    "mac-m2-max": {
        ...
        "geta": 0.26,
        "gl": 0.24,
        "hint": "Mac M2 Max, 400 GB/s unified [est, unvalidated]",
    },
    "mac-m3-max": {
        "vc": 96,
        "vb": 400,
        ...
        "geta": 0.26,
        "gl": 0.24,
        "hint": "Mac M3 Max, 400 GB/s unified [est, unvalidated]",
    },
    "mac-m4-max": {
        "vc": 128,
        "vb": 546,
        ...
        "geta": 0.26,
        "gl": 0.24,
        "hint": "Mac M4 Max, 546 GB/s unified [est, unvalidated]",
    },
    "mac-m2-ultra": {
        "vc": 192,
        "vb": 800,
        ...
        "geta": 0.25,
        "gl": 0.23,
        "hint": "Mac M2 Ultra, 800 GB/s unified [est, unvalidated]",
    },
    "mac-m3-ultra": {
        "vc": 512,
        "vb": 819,
        ...
        "geta": 0.25,
        "gl": 0.23,
        "hint": "Mac M3 Ultra 512GB, 819 GB/s [est, unvalidated]",
    },
    ...
    "ddr5": {
        ...
        "geta": 0.5,
        "gl": 0.3,
        "hint": "modern desktop DDR5, no GPU [est]",
    },
    "colibri": {
        "vc": 0,
        "vb": 0,
        ...
        "geta": 0.5,
        "gl": 0.3,
        "hint": "128 GB DDR5 workstation [est]",
    },
    "epyc-256": {
        "vc": 0,
        "vb": 0,
        ...
        "geta": 0.5,
        "gl": 0.3,
        "hint": "Epyc/Threadripper, 256GB, ~200 GB/s [est]",
    },
    "dgx-spark": {
        "vc": 128,
        "vb": 273,
        ...
        "geta": 0.79,
        "gl": 0.6,
        "hint": "NVIDIA DGX Spark / GB10, 128GB unified [validated vs published]",
    },
}
...
QUAL = {
    True: {2.0: 1.10, 2.5: 1.07, 3.0: 1.05, 4.5: 1.02, 6.5: 1.01, 8.5: 1.00},
...
def ubatch_flags(placement, vram_resident_gb, vc):
    ...
    if "split experts" in placement:
        ...
        return f"-b {ub} -ub {ub}" if ub else None
    if "experts->RAM" in placement:
        ...
        ub = max(
            safe_ubatch(head, cap=SAFE_UBATCH_CAP),
...
def phase_advice(placement, rows, vram_resident_gb=None, vc=None):
    ...
    alt_ub = (
        ubatch_flags(alt[0], vram_resident_gb or 0.0, vc) if vc else None
    ) or "-b 2048 -ub 2048"
    tail = ""
    if "-ub 4096" in alt_ub:
        tail = (
            " At -b 4096 -ub 4096 that placement measured 360.76 tok/s AT pp4096 out of "
    ...
    return (
        "this command is tuned for GENERATION. If your prompts are long - agent transcripts, "
...
def mmap_decision(host_gb, ram_gb):
    ...
    if not ram_gb or (host_gb or 0) <= ram_gb * MMAP_HOST_SHARE_CAP:
        return True, None
    return True, (
        f"RAM-TIGHT TRADE-OFF, both sides measured: this placement holds ~{host_gb:.0f}GB "
...
def moe_split_flags(frac, n_layer, host_gb=None, ram_gb=None):
    ...
    return '-ngl 99 -ot "blk\\.({})\\.ffn_.*_exps\\.=CPU"{}'.format(
...
def depth_scope_warning(placement, moe, ctx):
    ...
    if ctx <= 4096 or moe or "layers->VRAM" not in (placement or ""):
        return None
    return (
        f"DEPTH NOTE (preregs #73/#74, L-19): this is a DENSE split at {ctx} context, where "
...
def fits_in_vram_advice(placement, bits):
    ...
    if placement != "all in VRAM":
        return None
    note = (
        "we do not have a point prediction for this placement - measured efficiency varies "
    ...
    if bits < 4.5:
        note += (
            " It also already fits, and going lower-bit buys almost nothing: the same 7B at "
...
def format_advice(placement, bits):
    ...
    if bits <= 3.0:
        return (
            "FORMAT LEVER (pre-Ampere cards): this bit-width is in the regime where unpack "
    ...
    if bits <= 5.0:
        return (
            "FORMAT LEVER (pre-Ampere cards): at this bit-width the FORMAT is worth more than "
...
def dense_draft_note(moe, placement):
    ...
    if "layers->VRAM" in (placement or ""):
        return (
            "dense-SPLIT speculation (measured, prereg #69): a small same-family draft is "
    ...
    if "all in VRAM" not in placement:
        return None
    return (
        "dense-model speculation (measured, prereg #67): pairing this model with a small "
...
def speculation_advice(moe, placement, row=None):
    ...
    if moe and "split experts" in (placement or ""):
        ...
        head = (
            "if your output REUSES its context - edits, refactors, RAG quoting - add "
        ...
        return (
            head + "REQUIRES A LONG PROMPT: with these values the drafter "
    ...
    if moe and experts_offloaded:
        return (
            "speculation will NOT pay here with external drafts: measured +3% (ngram) and "
    ...
    if not moe:
        if oversold:
            return (
                "if you write CODE, add `--spec-type ngram-simple` - one flag, no download, "
        ...
        return (
            "if you write CODE, add `--spec-type ngram-simple "
...
RESOURCE_LABEL = {
    "vram_bw": "VRAM bandwidth",
    "ram_bw": "system RAM bandwidth",
    "io": "disk I/O",
    "cpu_compute": "CPU compute (attention over the KV cache)",
}
...
RESOURCE_CLASS = {
    "vram_bw": "bandwidth-bound",
    "ram_bw": "bandwidth-bound",
    "io": "IO-bound",
    "cpu_compute": "compute-bound",
}
...
RESOURCE_LEVER = {
    "vram_bw": "a faster GPU memory bus",
    "ram_bw": "faster RAM / XMP / more channels",
    "io": "faster storage, more I/O lanes",
...
def binding_constraint(row, capacity=None):
    ...
    out["lever_ceiling"] = {
        r: (1.0 / (1.0 - out["shares"].get(r, 0.0)) if out["shares"].get(r, 0.0) < 1.0 else None)
        for r in RESOURCES
    }
    if capacity:
...
def capacity_probe(ev, best_tps, size, kv_gb, vc, rc):
    ...
    for tier, cap, want, lever in (
        ...
        shaved = [
            r
            for r in ev(act_scale=fit_scale, true_size_gb_scale=fit_scale)
        ...
        if kv_gb > 0:
            ...
            if find["kv_closes"]:
                kv_rows = [
                    r for r in ev(kvp_scale=KV_Q8_BYTES_PER_F16_BYTE) if r[0].startswith(want)
                ]
...
def evaluate(
    ...
    if moe and vc > 0:
        ...
        if v_need <= vc * 0.95 and r_need <= ra:
            ...
            if r_need > ra * 0.45:
                pin = (
                    f"pins {r_need:.0f}GB of {ra:.0f}GB RAM (CUDA host memory) - fails under "
            ...
            out.append(
                Row(
                    "hybrid: attention->VRAM, experts->RAM",
                    1 / (act_ne / (geta * vb) + act_ex / (eta_r * rb) + kv_gb / (ETA_KV * vb)),
                    warn,
        ...
        if v_free > 0.3 and experts_gb > 0:
            ...
            if f > 0.05 and ram_left <= ra:
                ...
                if fl:
                    pin_warn = (
                        (
                            f"pins {ram_left:.0f}GB of {ra:.0f}GB RAM (CUDA host memory) - "
                    ...
                    s_vram = act_ne / (geta * vb) + f * act_ex / (geta * vb) + kv_gb / (ETA_KV * vb)
                    s_ram = (1 - f) * act_ex / (eta_r * rb)
                    out.append(
                        Row(
                            f"split experts: {f:.0%}->VRAM, rest->RAM",
                            1 / t_split,
                            pin_warn,
                            fl,
                            {"vram_bw": s_vram, "ram_bw": s_ram},
                        )
                    )
    if (not moe) and vc > 0 and size + kv_gb > vc * 0.90 and size + kv_gb <= ra + vc * 0.9:
        ...
        if 0 < gpu_layers < n_layer:
            ...
            out.append(
                Row(
                    f"split: {gpu_layers}/{n_layer} layers->VRAM, rest->RAM",
                    1
                    / (g * act / (geta_w * vb) + (1 - g) * act / (eta_r * rb) + kv_t + cpu_attn_t),
                    None,
                    f"-ngl {gpu_layers}",
    ...
    if size + kv_gb <= ra:
        ...
        out.append(
            Row(
                "pure CPU (GPU idle)",
                1 / (act / (eta_r * rb) + kv_gb / (ETA_KV * rb) + cpu_attn_all),
                warn,
                "-ngl 0",
                {"ram_bw": c_ram, "cpu_compute": cpu_attn_all},
            )
        )
    if size + kv_gb > ra:
        ...
        tps = 0.95 / (
            streamable * miss / db
            + (streamable * (1 - miss) + hot) / (eta_r * rb)
            + kv_gb / (ETA_KV * rb)
            + (n_layer or 32) * ctx * CPU_ATTN_S_PER_POS_LAYER
        )
        ...
        out.append(
            Row(
                ...
                disk_warn,
                "-ngl 0",
                {"io": k_io, "ram_bw": k_ram, "cpu_compute": k_cpu},
                eff=0.95,
            )
        )
            ...
            out.append(
                Row(
                    ...
                    "-ngl 99 + runtime-managed expert cache",
                    {
                        ...
                        "vram_bw": (
                            hit * vshare / (geta * vb) + hot / (geta * vb) + kv_gb / (ETA_KV * vb)
                        ),
                    },
                    eff=0.95,
                    runnable=False,
    ...
    if vc > 0 and size + kv_gb > vc * 0.90 and v_need <= vc * 0.90:
        ...
        t_ll = (
            size * miss_ll / db  # the part that must come off disk
            + size * (1 - miss_ll) / (eta_r * rb)  # the part host RAM can hold
            + kv_gb / (ETA_KV * vb)
        )  # KV stays on the GPU with the layer
        warn = (
            f"one layer resident ({layer_gb:.2f} GB of {size:.1f} GB); needs a "
            f"layer-streaming runtime (airllm/accelerate-class) - llama.cpp has no such mode"
        )
        if layer_gb * 2 + kv_gb + 0.5 > vc * 0.90:
            warn += (
                f"; no room to PREFETCH (needs {layer_gb * 2 + kv_gb + 0.5:.1f} GB for "
                f"double-buffering, you have {vc * 0.90:.1f}) - the ~10% overlap gain is off"
            )
        if moe:
            warn += (
                "; MoE PENALTY: this reads ALL experts every token, not just the active "
        ...
        warn += (
            "; UPPER BOUND - two costs are unpriced: host-to-device PCIe transfer of every "
...
def check_presets(args):
    ...
    if mdl and mdl not in MODELS and not getattr(args, "total", None):
        raise SystemExit(
            ...
            "  or point at a file:  --gguf model.gguf   (exact spec read from the GGUF)".format(
                mdl, ", ".join(sorted(MODELS))
            )
        )
    ...
    if mac and mac not in MACHINES:
        raise SystemExit(
            "unknown --machine '{}'.\n"
            "  presets: {}\n"
            "  or pass flags: --vram/--vram-bw/--ram/--ram-bw/--disk-bw   (no flags = auto-detect this box)".format(
...
def warn_if_no_model(args):
    ...
    if not (
        getattr(args, "model", None) or getattr(args, "total", None) or getattr(args, "gguf", None)
    ):
        print(
            "[quantprobe] NO MODEL GIVEN - assuming a generic 13B DENSE model. This number is "
...
CAL_COMPONENTS = (
    ("RAM stream", "ram_bw_measured"),
    ("disk", "disk_bw_measured"),
...
def calibration_gap_warning(cal):
    ...
    return [
        (
            f"[quantprobe] MIXED calibration state: {', '.join(missing)} still preset/spec-sheet, "
...
def apply_calibration_overrides(hw, args):
    ...
    if applied:
        stale = (
            f"; {age:.0f} days old - re-run `quantprobe calibrate`"
            if age and age > calmod.STALE_DAYS
            else ""
        )
        _cid = cal.get("cal_id")
        print(
            f"[quantprobe] calibration applied [{'; '.join(applied)}] ({cal.get('date', '?')}"
            + (f", state {_cid}" if _cid else "")
            + f"{stale})"
        )
...
def resolve_gpu_eta(hw, args, active_b, bits, vb, geta):
    ...
    if fmt_bw:
        ...
        if not use_ratio and ratio:
            print(
                f"[quantprobe] GPU eta from the measured format ladder: {eta_fmt:.2f} "
    ...
    if ratio and not use_ratio:
        print(
            "[quantprobe] GPU anchor is outside this model's size class - machine ratio not "
...
def resolve_cpu_bw(hw, args, active_b, bits, rb):
    ...
    if same_class or act_est < 1.5:
        return rb * ratio
    print(
        "[quantprobe] CPU anchor is outside this model's size class - machine ratio not "
        "applied (small anchors mis-price big models; #65)."
    )
    return rb
...
def append_threads_flag(flags, placement):
    ...
    if (
        n
        and any(k in placement for k in ("->RAM", "CPU", "disk", "split experts"))
...
UPGRADES = (
    ("enable XMP (free)", "ram_bw", {"rb": 48}),
    ("+16 GB RAM", "ram_capacity", {"rc_delta": 16}),
    ("NVMe SSD", "io", {"db": 3.5}),
)
...
def binding_report(bc, bits=None, placement=None):
    ...
    scope_label = (
        "  validation       derived from the law, not confirmed by variance "
    ...
    if cap:
        ...
        if cap.get("kv_closes"):
            lines.append(
                f"  KV lever         PREFER THIS at depth over dropping a quant tier: "
            ...
            lines.append(
                f"  KV lever         partial: quantizing the KV cache (-ctk q8_0 "
        ...
        if bc.get("ceiling_x"):
            ...
            lines.append(
                f"  ceiling          {bc['ceiling_x']:.2f}x if you fixed "
    ...
    if placement == "all in VRAM" and bits is not None and bits < 4.5:
        lines.append(
            "  CAVEAT (#16/#52): our GPU efficiency fuses bandwidth and UNPACK ALU into one "
    ...
    lines.append(
        "  scope            DECODE only. Prefill has a different binding constraint "
...
def resolve_hw(args, announce=True):
    ...
    if not hw and all(
        getattr(args, k, None) is None for k in ("vram", "vram_bw", "ram", "ram_bw", "disk_bw")
    ):
    ...
    vc = hw.get("vc", getattr(args, "vram", None))
    vb = hw.get("vb", getattr(args, "vram_bw", None))
    rc = hw.get("rc", getattr(args, "ram", None))
    rb = hw.get("rb", getattr(args, "ram_bw", None))
    db = hw.get("db", getattr(args, "disk_bw", None))
    geta = hw.get("geta", 0.45)
    gl = hw.get("gl", None)
    if getattr(args, "vram", None) is not None:
        vc = args.vram
    if getattr(args, "vram_bw", None) is not None:
        vb = args.vram_bw
    if getattr(args, "ram", None) is not None:
        rc = args.ram
    if getattr(args, "ram_bw", None) is not None:
        rb = args.ram_bw
    if getattr(args, "disk_bw", None) is not None:
        db = args.disk_bw
    vc = agg_cap(vc) or 0
    vb = agg_bw(vb, 0.85) or 0
    rc = rc or 16
    rb = rb or 40
    ...
    if vc > 0 and vb <= 0:
        ...
        if announce:
            print(
                f"[quantprobe] --vram {vc:g} given without --vram-bw: using {vb:g} GB/s "
...
def build_rows(args):
    ...
    kvp = args.kv_per_pos * 1024 if getattr(args, "kv_per_pos", None) else m.get("kvp", DEFAULT_KVP)
    ...
    cap_find = (
        capacity_probe(ev, best[1], size, ctx * kvp / 1e9 if ctx > 0 else 0.0, vc, rc)
        if best
        else None
    )
    ...
    return {
        "inputs": {
            ...
            "codebook_share": getattr(args, "codebook_share", 0.0),
            "model_hint": m.get("hint"),
            "machine_hint": hw.get("hint"),
        },
        "hw": {
            "vc": vc,
            "vb": vb,
            ...
            "gpu_ratio": hw.get("_gpu_ratio"),
            "cpu_ratio": hw.get("_cpu_ratio"),
        },
        "size": size,
        "act": act,
        "q": q,
...
def run(args):
    ...
    kvline = f" | ctx {ctx}: +{ctx * kvp / 1e9:.2f} GB KV read/token" if ctx > 0 else ""
    print(
        f"  model {size:.1f} GB | active {act:.2f} GB/token{kvline} | est. quality cost x{q:.2f} "
    ...
    if "--threads" in run_flags:
        print(
            f"           (--threads {nthreads} = this machine's LOGICAL cores; llama.cpp's own"
    ...
    if getattr(args, "iq_share", 0.0) > 0.3 and any(
        ...
        if bound:
            ...
            if bound >= 1.05:
                print(
                    f"  ON THIS ROW it is worth at most **{(bound - 1) * 100:.0f}%**"
                ...
                print(
                    f"  ON THIS ROW the fix is worth at most **{(bound - 1) * 100:.1f}%** -"
    ...
    ph = phase_advice(
        best[0], cfgs, vram_resident_gb=moe_vram_resident_gb(ne, args.bits, moe), vc=vc
    )
    if ph:
        print(f"\n  phase: {ph}")
        ...
        if chat["label"] != rag["label"]:
            ...
            print(
                f"    chat, short prompts     -> {chat['label']:<26} {chat['pp']:>6.0f} pp / {chat['tg']:>5.1f} tg"
            )
            print(
                f"    long prompts, RAG, docs -> {rag['label']:<26} {rag['pp']:>6.0f} pp / {rag['tg']:>5.1f} tg"
            )
            print(
                f"  Choosing wrong costs up to {rag['speedup_vs_worst']:.2f}x on a long-prompt workload."
            )
        else:
            print(f"\n  workload: one setup wins at every prompt:generation ratio - {rag['label']}")
            print(
                f"  ({rag['pp']:.0f} pp2048 / {rag['tg']:.1f} tg128 - REFERENCE-BOX numbers at "
                "those exact batch sizes;"
            )
            print(
                "  a 22-token prompt measures startup, not prefill). Earlier versions offered a "
                "choice here; re-measuring"
            )
            print(
                "  every cell in ONE session (pre-registration #25) showed the alternatives were "
                "dominated,"
            )
            print("  so there is nothing to choose. One fewer knob, and the honest number.")
            print()
            print(
                "  honesty on GENERATION speed (preregs #43/#60/#61): a plain fixed -ngl split measures"
            )
            print(
                "  EQUAL tg to this -ot placement - three times, at degraded AND full clocks. The -ot"
            )
            print(
                "  advice earns its keep on PROMPT PROCESSING (2.2x measured), on keeping KV in VRAM,"
            )
            ...
            print(
                "  tok/s decode against q8_0 KV at d16384 - 3.04x WORSE, for a prefill difference"
            )
            print(
                "  inside the error bar (prereg #25). Deep workloads (RAG at 50:1-200:1) are where"
            )
            print(
                "  it loses hardest; that advice is WITHDRAWN per prereg #25's pre-commitment (L-24)."
            )
            print(
                "  IF YOUR NUMBERS SAG 25-30% after hours of GPU churn: the cause on our box was a"
            )
            print(
                "  STUCK BOOST STATE (SM 1506 vs 1835+ MHz at cool temps - diagnosed and confirmed by"
            )
            print(
                "  cold-boot A/B, preregs #60/#61). Check `nvidia-smi --query-gpu=clocks.sm` (NVIDIA)"
            )
    ...
    if ub:
        ...
        if "experts->RAM" in best[0]:
            ...
            if _cell:
                ...
                _worth = (
                    f"is worth **{_gain:+.0%} prefill** on this placement (measured "
                    f"{UB_SWEEP_PP2048[512]:.1f} -> {_cell:.1f} pp2048 against the ub-512 "
                    f"baseline, pre-registration #19)"
                )
            else:
                _worth = (
                    "is the sized safe batch for this card; prereg #19 swept this placement "
            ...
            if "-ub 4096" in ub:
                print(
                    "  L-26 (out of sample; predictions staked in "
                    "weights/data/prereg92b_ub_oos.log before the run):\n  at "
                    "-b 4096 -ub 4096 this placement "
                    "measured 360.76 tok/s\n  AT pp4096. The prefill law sec/tok = A + X/C "
                    "held at C=256 (-0.27%) and C=4096 (-8.2%,\n  in band). READ THE COMPARISON "
                    "CAREFULLY: the published ub-2048 number, 345.89, is a\n  pp2048 "
                    "measurement (prereg #19) - a different prompt length - and the "
                    "pp4096-at-ub2048\n  control was never run, so the ~+4% between them is "
                    "what the law implies, not a measured\n  A/B. -ub is a CAP: on prompts of "
                    "2048 tokens or fewer this flag changes nothing. The law\n  is validated "
                    "TO C=4096 and not past it (the asymptote bends below 1/A), so do not "
    ...
    if adv:
        ...
        if sc:
            ...
            if sc < 1.5:
                ...
                print(
                    f"  (upper bounds from this row's own decomposition, at 100% acceptance: "
                ...
                print(
                    f"  (upper bound on this row from its own decomposition: {sc:.2f}x for a "
    ...
    for name, resource, _over in UPGRADES:
        ...
        dead.append(
            f"{name}: "
            + (
                f"{RESOURCE_LABEL[resource]} is 0% of this token"
                if sh <= 0
                else f"capped at {1.0 / (1.0 - sh):.2f}x ({RESOURCE_LABEL[resource]} "
    ...
    if cap_find and max(cap_find["gain_shave"], cap_find["gain_lift"]) >= CAP_PROMOTION_MIN:
        if cap_find["gain_shave"] >= CAP_PROMOTION_MIN:
            print(
                f"  tier-boundary advisor: this config is {cap_find['gap_gb']:.1f} GB over the "
        ...
        if cap_find.get("kv_closes"):
            print(
                f"  tier-boundary advisor: deep-context preference (L-24) - quantize the KV "
    ...
    if (
        bc
        and bc["shares"].get("cpu_compute", 0.0) > bc["shares"].get("ram_bw", 0.0)
        and bc["shares"].get("cpu_compute", 0.0) > bc["shares"].get("vram_bw", 0.0)
    ):
        print(
            f"  ...but NOT on this row: {bc['shares']['cpu_compute']:.0%} of this token is CPU "
